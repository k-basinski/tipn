...
# Pliki i foldery - powtórka z podstawówki

## Plik

- Miejsce w pamięci, w którym trzymamy dane
- Pliki mają różne typy (obrazki, dźwięki, filmy, itd.)
- Odzwierciedleniem typu jest (najczęściej) **rozszerzenie** - litery po ostatniej kropce

## Nazwy plików - dobre rady
...
- Foldery to miejsca, w których trzymamy pliki i inne foldery
- Foldery mają strukturę drzewa
